...
export class AxiosHttpClient implements HttpClient {
  ...
  constructor() {
    throw new Error('AxiosHttpClient is deprecated. Use MeroHttpClientAdapter instead.');
  }
  ...
  async head(): Promise<import('../types/api-response').ResponseData<import('./httpClientAdapter').HeadResponse>> {
    throw new Error('AxiosHttpClient is deprecated');
  }
}
