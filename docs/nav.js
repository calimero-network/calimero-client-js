/* TypeScript SDK Docs — Shared Navigation + Full-text Search */
(function () {
  'use strict';

  const REPO = 'https://github.com/calimero-network/calimero-client-js';
  const PAGES_BASE = './';
    ...
    sb.innerHTML = `
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>Client JS</em></strong>
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
          <a href="https://github.com/calimero-network/calimero-client-js" target="_blank" rel="noopener">
